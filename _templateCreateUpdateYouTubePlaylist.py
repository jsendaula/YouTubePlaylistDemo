...
def authenticate_youtube():
    ...
    flow = InstalledAppFlow.from_client_secrets_file("client_secret_897398147357-a2lf6ui0766n9du4s9bd7o2us5teia06.apps.googleusercontent.com.json", SCOPES)
...
if __name__ == "__main__":
    ...
    # ---- Playlist details ----
    title = "My Playlist (No Duplicates)"
